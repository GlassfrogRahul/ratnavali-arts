                ...
                <div class="row pt-5">
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="service-card ml-auto mr-auto">
                            <img src="./asssets/images/redesigning.png" loading="lazy" width="100%" height="auto" alt="">
                            <h3>REDESIGNING</h3>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card ml-lg-auto ml-auto mr-auto">
                            <img src="./asssets/images/customized-jewelary-making.png" loading="lazy" width="100%" height="auto" alt="">
                            <h3>CUSTOMISED JEWELRY MAKING</h3>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card mr-lg-auto ml-auto mr-auto">
                            <img src="./asssets/images/jewelary-polishing.png" loading="lazy" width="100%" height="auto" alt="">
