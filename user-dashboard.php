                    ...
                    ?>
                        <div class="col-md-4 col-sm-6 mx-auto">
                            <div class="card">
                                ...
                                <img src="./asssets/svg/Notification.svg" class="mt-3 mb-2" alt="Done">
                                <h2 class="mb-5 text-center">No appoinments <br> scheduled</h2>


                                <a href="book-appointment.php" class="btn">Schedule now</a>
                            </div>
                        </div>
                    ...
                    ?>
                        <div class="col-md-4 col-sm-6">
                            <div class="card">
                                ...
                                <h2 class="mb text-center">Book new <br> appointment</h2>
